...
/**
 * Wrapper for SVG Image manipulation
 * 
 * @author osiris
 * 
 */
public class FileUtil {
	 ...
	 * 
	 * @param name
	 *            of the file - can be without extension
	 * @return InputStream of loaded class
	 */
	...
	/**
	 * Highlights the appropriate (active) process node based on the various information which determines the process
	 * state
	 * 
	 * @param is
	 *            input stream of svg image
	 * @param processName
	 * @param processState
	 * @param servicesQueried
	 * @param passedTests
	 * @param serviceSelected
	 * @return InputStream of a processed image
	 */
	public InputStream processSvg(InputStream is, String processName, String processState, Boolean servicesQueried, Boolean passedTests,
		...
		if (processState == null && processName.toLowerCase().contains("exist")) {
			...
			output = input
					.replace(
							"<rect id=\"_E35C0A48-354D-43D1-A277-9AC67A3AE5B2bg_frame\" oryx:resize=\"vertical horizontal\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:url(#_E35C0A48-354D-43D1-A277-9AC67A3AE5B2background);stroke:#000000;stroke-width:1\" />",
		...
		if (!serviceSelected && processName.toLowerCase().contains("exist") && processState != null) {
			...
			output = input
					.replace(
							"<rect id=\"_34BA16F3-5FD2-4D3C-9B3A-B5483FF6605Bbg_frame\" oryx:resize=\"vertical horizontal\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:url(#_34BA16F3-5FD2-4D3C-9B3A-B5483FF6605Bbackground);stroke:#000000;stroke-width:1\" />",
		...
		if (processState != null && processSvg) {
			...
			case "registered": {
				if (processName.toLowerCase().contains("new")) {
					if (!servicesQueried) {
						output = input
								.replace(
										"<rect id=\"_7A06414E-66A9-4AA3-90DF-7580708F55B1frame\" oryx:resize=\"vertical horizontal\" oryx:anchors=\"bottom top right left\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:none;stroke:#000000;stroke-width:4\" />",
						...
						output = input
								.replace(
										"<rect id=\"_5AF26B3E-895F-4B56-B07B-E095C7FB2C7Ebg_frame\" oryx:resize=\"vertical horizontal\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:url(#radialGradient5257);stroke:#000000;stroke-width:1\" />",
			...
			case "InTest": {
				...
				if (processName.toLowerCase().contains("new") && passedTests) {
					...
					output = input
							.replace(
									"<rect id=\"_EE6CA2B1-51CF-460B-9069-3147DBA9AA19frame\" oryx:resize=\"vertical horizontal\" oryx:anchors=\"bottom top right left\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:none;stroke:#000000;stroke-width:4\" />",
				...
				// evaluate tests result
					...
					output = input
							.replace(
									"<rect id=\"_4245D8F1-E391-4D62-8DA1-2A888705FD9Cbg_frame\" oryx:resize=\"vertical horizontal\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:url(#radialGradient5311);stroke:#000000;stroke-width:1\" />",
					...
					output = input
							.replace(
									"<rect id=\"_551CFE4C-F00F-42C9-A252-F702C1A339B5frame\" oryx:resize=\"vertical horizontal\" oryx:anchors=\"bottom top right left\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:none;stroke:#000000;stroke-width:4\" />",
					...
					output = input
							.replace(
									"<rect id=\"_DC411D5C-CD72-4F6B-BB58-610ED5DC33D1bg_frame\" oryx:resize=\"vertical horizontal\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:url(#_DC411D5C-CD72-4F6B-BB58-610ED5DC33D1background);stroke:#000000;stroke-width:1\" />",
			...
			case "Available": {
				...
				if (processName.toLowerCase().contains("new")) {
					...
					output = input
							.replace(
									"<rect id=\"_04D14669-B0C7-4052-A073-5EA3008B8417frame\" oryx:resize=\"vertical horizontal\" oryx:anchors=\"bottom top right left\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:none;stroke:#000000;stroke-width:4\" />",
					...
					output = input
							.replace(
									"<rect id=\"_EA37E573-396E-40AB-977C-50BB516005E5frame\" oryx:resize=\"vertical horizontal\" oryx:anchors=\"bottom top right left\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:none;stroke:#000000;stroke-width:4\" />",
			...
			case "Deprecated": {
				if (processName.toLowerCase().contains("new")) {
					...
					output = input
							.replace(
									"<rect id=\"_50E71468-5EE8-4172-BFB5-7E80F484E994frame\" oryx:resize=\"vertical horizontal\" oryx:anchors=\"bottom top right left\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:none;stroke:#000000;stroke-width:4\" />",
					...
					output = input
							.replace(
									"<rect id=\"_49407B96-9644-4699-9E13-E3B7C6EA42FCframe\" oryx:resize=\"vertical horizontal\" oryx:anchors=\"bottom top right left\" x=\"0\" y=\"0\" width=\"100\" height=\"80\" rx=\"10\" ry=\"10\" style=\"fill:none;stroke:#000000;stroke-width:4\" />",
